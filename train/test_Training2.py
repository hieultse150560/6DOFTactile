...
parser.add_argument('--exp', type=str, default='singlePeopleTest', help='Name of experiment')
...
parser.add_argument('--numwork', type=int, default=64, help='The number of workers')
...
# Run with test set  
    ...
    for epoch in range(args.epoch):
        ...
        for i_batch, sample_batched in bar(enumerate(train_dataloader, 0)):
            ...
            optimizer.step()
            stop = timeit.default_timer()
            print('Time for Back Propagation each training batch: ', stop - start)  
