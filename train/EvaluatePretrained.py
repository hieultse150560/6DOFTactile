...
parser.add_argument('--exp', type=str, default='singlePeoplePretrained', help='Name of experiment')
...
checkpoint = torch.load(args.exp_dir + 'ckptsOri/singlePerson_0.0001_10_best.path.tar')
model.load_state_dict(checkpoint['model_state_dict'])
optimizer.load_state_dict(checkpoint['optimizer_state_dict'])
epochs = checkpoint['epoch']
loss = checkpoint['loss']
print("Loaded loss:", loss)
print("ckpt loaded from:", args.exp_dir + 'ckptsOri/singlePerson_0.0001_10_best.path.tar')
