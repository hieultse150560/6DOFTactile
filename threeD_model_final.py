# threeD_model_final.py: Define model
import numpy as np
import torch
...
# Apply softmax for axis 0 of the volume
def softmax(data):
...
# Lấy heatmap và keypoints (Softmax) là expected value từ input là output predicted
